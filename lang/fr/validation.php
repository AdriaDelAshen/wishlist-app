...
return [
    ...
    */
    ...
    'custom' => [
        'errors' => [
            'random_string_too_short' => '$keyspace doit avoir au moins 2 caractères de long.',
        ],
        'generic' => [
        ...
        'user' => [
            ...
            'must_be_approved_or_does_not_exist' => 'Le compte doit être approuvé ou n\'existe pas.',
        ],
        'wishlist' => [
            'cannot_be_deleted' => 'Vous ne pouvez pas supprimer cette liste de souhaits.',
        ],
        'wishlist_item' => [
            'cannot_be_created' => 'Vous ne pouvez pas créer cet item.',
            'cannot_be_updated' => 'Vous ne pouvez pas modifier cet item.',
