...
return [
    ...
    */
    ...
    'custom' => [
        'errors' => [
            'random_string_too_short' => '$keyspace must be at least two characters long.',
        ],
        'generic' => [
        ...
        'user' => [
            ...
            'must_be_approved_or_does_not_exist' => 'The account must be approved or does not exist.',
        ],
        'wishlist' => [
            'cannot_be_deleted' => 'You cannot delete this wishlist.',
        ],
        'wishlist_item' => [
            'cannot_be_created' => 'You cannot create this item.',
            'cannot_be_updated' => 'You cannot update this item.',
